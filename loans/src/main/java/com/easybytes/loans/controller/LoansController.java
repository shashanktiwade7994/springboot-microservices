...
import com.easybytes.loans.dto.LoansConatctInfoDto;
...
public class LoansController {
    ...
    @Autowired
    private LoansConatctInfoDto loansConatctInfoDto;
    ...
    public ResponseEntity<LoansConatctInfoDto> getContactInfo() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(loansConatctInfoDto);
    }
